 ...
 * @author 343033031
 */
public class Sc2 extends javax.swing.JFrame {

    /**
     * Creates new form Sc2
     */
    public Sc2() {
        initComponents();
        addWindowListener(new WindowAdapter() {
            ...
            Main.cases[1].getCaseType();
                System.out.println("JFrame is now focused!");
                //add code here
                // display info from array
                jLabel2.setText(Main.cases[1].getCaseTitle());
                jLabel4.setText(Main.cases[1].getCategory());
                jTextArea1.setText(Main.cases[1].getCaseDescription());
            }
        });
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sc2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
